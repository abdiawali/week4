...
class TestStudentLists(TestCase):
    ...
    def test_remove_student_who_is_not_in_the_list_raises_student_error(self):
        ...
        #remove student that is not in the list
        with self.assertRaises(StudentError):
    ...
    # use assertTrue.
    def test_that_checks_if_class_is_full(self):
    ...
    def test_that_checks_the_class_is_not_full(self):
        test_class = ClassList(4)
        test_class.add_student('kaka')
        test_class.add_student('ozil')
        test_class.add_student('salah')
